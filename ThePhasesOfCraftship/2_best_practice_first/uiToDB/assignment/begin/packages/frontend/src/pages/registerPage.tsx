...
import { api } from "../App";
import { newSelectors, toId } from "../shared/selectors";
...
const notificationSelector = newSelectors.notifications;
  ...
  const handleSubmitRegistrationForm = async (
    ...
    if (!validationResult.success) {
      ...
      return toast.error(validationResult.errorMessage, {
        toastId: toId(notificationSelector.errorMessage.selector),
      });
    }
